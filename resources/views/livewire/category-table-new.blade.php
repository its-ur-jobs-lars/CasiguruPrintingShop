                    ...
                    <table class="min-w-full border-collapse">
                        ...
                        <tbody>
                            @forelse($records as $index => $record)
                                <tr class="border-b">
                                    <td class="px-4 py-2">{{ $record->category_id }}</td>
                                    <td class="px-4 py-2">{{ $record->category_name }}</td>
...
<div class="fixed bottom-0 left-0 w-full p-2 z-20">
    <span class="text-sm text-gray-600">Total number of Category : {{ $this->rowCount }}</span>
</div>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="editCat.category_name" class="form-control" required>
                            </div>

                            {{-- Description --}}
                            <div class="form-group">
                                <label style="color:black;">Description</label>
                                <input type="text" wire:model="editCat.description" class="form-control" required>
                            </div>
                            
                            <div class="form-group">
                                <label style="color:black;">Status</label>
                               <select wire:model="editCat.isActive" class="form-control" required>
