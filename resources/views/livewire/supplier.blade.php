<div>
    ...
    <button wire:click="openModal" class="btn btn-primary">Add Supplier</button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color:black;">Add Supplier</h5>
                    </div>
                        ...
                        <form wire:submit.prevent="save">
                            ...
                            <div class="form-group">
                                <label style="color:black;">Supplier name</label>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" wire:model="data.contact_person" class="form-control" required>
                            </div>

                              <div class="form-group">
                                <label style="color:black;">Contact Number</label>
                                <input type="text" wire:model="data.contact_number" class="form-control" required>
                            </div>
